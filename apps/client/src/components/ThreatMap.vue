...
const getRegionClass = (countryId: string): string => {
  const region = getRegionOfCountry(countryId);
  if (!region) return 'fill-[#090d16]';
  const stats = hubMetrics.value[region];
  if (stats && stats.total > 0) {
    if (stats.critical > 0) return 'fill-[#f7768e]/25 hover:fill-[#f7768e]/40';
    if (stats.high > 0) return 'fill-[#e0af68]/25 hover:fill-[#e0af68]/40';
    return 'fill-[#38bdf8]/25 hover:fill-[#38bdf8]/40';
  }
  return 'fill-[#0f172a]/50 hover:fill-[#1e293b]/60';
};
    ...
    <div class="flex-1 min-h-[220px] relative border border-border-primary/20 rounded-xl bg-[#030307]/50 flex items-center justify-center overflow-hidden">
      ...
      <path
        ...
        :class="[
          ...
          selectedRegion === getRegionOfCountry('_somaliland') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('_somaliland')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('_somaliland')"
      />
      <path
        id="ae"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ae') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ae')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ae')"
      />
      <path
        id="af"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('af') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('af')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('af')"
      />
      <path
        id="al"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('al') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('al')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('al')"
      />
      <path
        id="am"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('am') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('am')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('am')"
      />
      <path
        id="at"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('at') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('at')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('at')"
      />
      <path
        id="az"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('az') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('az')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('az')"
      />
      <path
        id="ba"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ba') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ba')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ba')"
      />
      <path
        id="bd"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('bd') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('bd')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('bd')"
      />
      <path
        id="be"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('be') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('be')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('be')"
      />
      <path
        id="bf"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('bf') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('bf')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('bf')"
      />
      <path
        id="bg"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('bg') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('bg')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('bg')"
      />
      <path
        id="bi"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('bi') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('bi')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('bi')"
      />
      <path
        id="bj"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('bj') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('bj')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('bj')"
      />
      <path
        id="bn"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('bn') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('bn')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('bn')"
      />
      <path
        id="bo"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('bo') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('bo')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('bo')"
      />
      <path
        id="br"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('br') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('br')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('br')"
      />
      <path
        id="bt"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('bt') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('bt')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('bt')"
      />
      <path
        id="bw"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('bw') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('bw')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('bw')"
      />
      <path
        id="by"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('by') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('by')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('by')"
      />
      <path
        id="bz"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('bz') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('bz')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('bz')"
      />
      <path
        id="cd"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('cd') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('cd')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('cd')"
      />
      <path
        id="cf"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('cf') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('cf')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('cf')"
      />
      <path
        id="cg"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('cg') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('cg')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('cg')"
      />
      <path
        id="ch"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ch') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ch')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ch')"
      />
      <path
        id="ci"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ci') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ci')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ci')"
      />
      <path
        id="cm"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('cm') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('cm')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('cm')"
      />
      <path
        id="co"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('co') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('co')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('co')"
      />
      <path
        id="cr"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('cr') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('cr')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('cr')"
      />
      <path
        id="cu"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('cu') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('cu')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('cu')"
      />
      <path
        id="cy"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('cy') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('cy')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('cy')"
      />
      <path
        id="cz"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('cz') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('cz')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('cz')"
      />
      <path
        id="de"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('de') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('de')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('de')"
      />
      <path
        id="dj"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('dj') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('dj')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('dj')"
      />
      <path
        id="dm"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('dm') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('dm')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('dm')"
      />
      <path
        id="do"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('do') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('do')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('do')"
      />
      <path
        id="dz"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('dz') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('dz')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('dz')"
      />
      <path
        id="eg"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('eg') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('eg')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('eg')"
      />
      <path
        id="er"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('er') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('er')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('er')"
      />
      <path
        id="et"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('et') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('et')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('et')"
      />
      <path
        id="fi"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('fi') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('fi')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('fi')"
      />
      <path
        id="ga"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ga') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ga')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ga')"
      />
      <path
        id="ge"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ge') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ge')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ge')"
      />
      <path
        id="gh"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('gh') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('gh')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('gh')"
      />
      <path
        id="gm"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('gm') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('gm')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('gm')"
      />
      <path
        id="gn"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('gn') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('gn')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('gn')"
      />
      <path
        id="gt"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('gt') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('gt')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('gt')"
      />
      <path
        id="gw"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('gw') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('gw')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('gw')"
      />
      <path
        id="gy"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('gy') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('gy')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('gy')"
      />
      <path
        id="hn"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('hn') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('hn')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('hn')"
      />
      <path
        id="hr"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('hr') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('hr')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('hr')"
      />
      <path
        id="ht"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ht') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ht')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ht')"
      />
      <path
        id="hu"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('hu') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('hu')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('hu')"
      />
      <path
        id="ie"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ie') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ie')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ie')"
      />
      <path
        id="il"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('il') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('il')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('il')"
      />
      <path
        id="in"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('in') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('in')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('in')"
      />
      <path
        id="iq"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('iq') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('iq')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('iq')"
      />
      <path
        id="ir"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ir') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ir')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ir')"
      />
      <path
        id="is"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('is') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('is')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('is')"
      />
      <path
        id="jm"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('jm') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('jm')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('jm')"
      />
      <path
        id="jo"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('jo') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('jo')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('jo')"
      />
      <path
        id="ke"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ke') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ke')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ke')"
      />
      <path
        id="kg"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('kg') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('kg')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('kg')"
      />
      <path
        id="kh"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('kh') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('kh')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('kh')"
      />
      <path
        id="km"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('km') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('km')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('km')"
      />
      <path
        id="kp"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('kp') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('kp')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('kp')"
      />
      <path
        id="kr"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('kr') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('kr')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('kr')"
      />
      <path
        id="kw"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('kw') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('kw')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('kw')"
      />
      <path
        id="kz"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('kz') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('kz')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('kz')"
      />
      <path
        id="la"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('la') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('la')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('la')"
      />
      <path
        id="lb"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('lb') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('lb')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('lb')"
      />
      <path
        id="lc"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('lc') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('lc')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('lc')"
      />
      <path
        id="lk"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('lk') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('lk')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('lk')"
      />
      <path
        id="lr"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('lr') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('lr')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('lr')"
      />
      <path
        id="ls"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ls') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ls')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ls')"
      />
      <path
        id="lt"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('lt') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('lt')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('lt')"
      />
      <path
        id="lu"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('lu') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('lu')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('lu')"
      />
      <path
        id="lv"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('lv') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('lv')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('lv')"
      />
      <path
        id="ly"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ly') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ly')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ly')"
      />
      <path
        id="ma"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ma') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ma')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ma')"
      />
      <path
        id="md"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('md') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('md')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('md')"
      />
      <path
        id="me"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('me') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('me')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('me')"
      />
      <path
        id="mg"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('mg') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('mg')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('mg')"
      />
      <path
        id="mk"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('mk') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('mk')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('mk')"
      />
      <path
        id="ml"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ml') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ml')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ml')"
      />
      <path
        id="mm"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('mm') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('mm')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('mm')"
      />
      <path
        id="mn"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('mn') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('mn')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('mn')"
      />
      <path
        id="mr"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('mr') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('mr')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('mr')"
      />
      <path
        id="mt"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('mt') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('mt')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('mt')"
      />
      <path
        id="mu"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('mu') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('mu')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('mu')"
      />
      <path
        id="mw"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('mw') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('mw')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('mw')"
      />
      <path
        id="mx"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('mx') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('mx')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('mx')"
      />
      <path
        id="mz"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('mz') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('mz')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('mz')"
      />
      <path
        id="na"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('na') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('na')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('na')"
      />
      <path
        id="nc"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('nc') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('nc')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('nc')"
      />
      <path
        id="ne"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ne') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ne')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ne')"
      />
      <path
        id="ng"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ng') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ng')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ng')"
      />
      <path
        id="ni"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ni') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ni')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ni')"
      />
      <path
        id="nl"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('nl') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('nl')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('nl')"
      />
      <path
        id="np"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('np') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('np')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('np')"
      />
      <path
        id="om"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('om') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('om')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('om')"
      />
      <path
        id="pa"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('pa') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('pa')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('pa')"
      />
      <path
        id="pe"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('pe') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('pe')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('pe')"
      />
      <path
        id="pk"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('pk') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('pk')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('pk')"
      />
      <path
        id="pl"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('pl') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('pl')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('pl')"
      />
      <path
        id="pr"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('pr') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('pr')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('pr')"
      />
      <path
        id="py"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('py') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('py')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('py')"
      />
      <path
        id="qa"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('qa') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('qa')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('qa')"
      />
      <path
        id="ro"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ro') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ro')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ro')"
      />
      <path
        id="rs"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('rs') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('rs')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('rs')"
      />
      <path
        id="rw"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('rw') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('rw')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('rw')"
      />
      <path
        id="sa"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sa') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sa')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sa')"
      />
      <path
        id="sd"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sd') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sd')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sd')"
      />
      <path
        id="sg"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sg') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sg')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sg')"
      />
      <path
        id="si"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('si') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('si')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('si')"
      />
      <path
        id="sk"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sk') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sk')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sk')"
      />
      <path
        id="sl"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sl') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sl')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sl')"
      />
      <path
        id="sn"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sn') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sn')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sn')"
      />
      <path
        id="so"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('so') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('so')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('so')"
      />
      <path
        id="sr"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sr') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sr')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sr')"
      />
      <path
        id="ss"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ss') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ss')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ss')"
      />
      <path
        id="sv"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sv') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sv')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sv')"
      />
      <path
        id="sy"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sy') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sy')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sy')"
      />
      <path
        id="sz"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sz') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sz')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sz')"
      />
      <path
        id="td"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('td') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('td')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('td')"
      />
      <path
        id="tg"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('tg') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('tg')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('tg')"
      />
      <path
        id="th"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('th') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('th')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('th')"
      />
      <path
        id="tj"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('tj') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('tj')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('tj')"
      />
      <path
        id="tm"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('tm') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('tm')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('tm')"
      />
      <path
        id="tn"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('tn') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('tn')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('tn')"
      />
      <path
        id="tr"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('tr') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('tr')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('tr')"
      />
      <path
        id="tt"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('tt') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('tt')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('tt')"
      />
      <path
        id="tw"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('tw') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('tw')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('tw')"
      />
      <path
        id="tz"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('tz') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('tz')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('tz')"
      />
      <path
        id="ua"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ua') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ua')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ua')"
      />
      <path
        id="ug"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ug') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ug')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ug')"
      />
      <path
        id="uy"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('uy') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('uy')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('uy')"
      />
      <path
        id="uz"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('uz') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('uz')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('uz')"
      />
      <path
        id="ve"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ve') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ve')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ve')"
      />
      <path
        id="vn"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('vn') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('vn')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('vn')"
      />
      <path
        id="za"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('za') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('za')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('za')"
      />
      <path
        id="zm"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('zm') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('zm')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('zm')"
      />
      <path
        id="zw"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('zw') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('zw')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('zw')"
      />
      <path
        id="ao_0"
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ao') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ao')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ao')"
      />
      <path
        id="ao_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ar') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ar')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ar')"
      />
      <path
        id="ar_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('au') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('au')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('au')"
      />
      <path
        id="au_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('bs') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('bs')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('bs')"
      />
      <path
        id="bs_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ca') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ca')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ca')"
      />
      <path
        id="ca_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('cl') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('cl')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('cl')"
      />
      <path
        id="cl_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('cn') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('cn')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('cn')"
      />
      <path
        id="cn_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('cv') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('cv')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('cv')"
      />
      <path
        id="cv_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('dk') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('dk')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('dk')"
      />
      <path
        id="dk_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ec') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ec')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ec')"
      />
      <path
        id="ec_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ee') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ee')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ee')"
      />
      <path
        id="ee_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('es') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('es')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('es')"
      />
      <path
        id="es_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('fk') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('fk')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('fk')"
      />
      <path
        id="fk_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('fr') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('fr')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('fr')"
      />
      <path
        id="fr_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('gb') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('gb')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('gb')"
      />
      <path
        id="gb_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('gl') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('gl')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('gl')"
      />
      <path
        id="gl_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('gq') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('gq')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('gq')"
      />
      <path
        id="gq_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('gr') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('gr')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('gr')"
      />
      <path
        id="gr_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('id') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('id')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('id')"
      />
      <path
        id="id_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('it') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('it')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('it')"
      />
      <path
        id="it_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('jp') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('jp')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('jp')"
      />
      <path
        id="jp_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('mv') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('mv')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('mv')"
      />
      <path
        id="mv_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('my') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('my')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('my')"
      />
      <path
        id="my_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('no') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('no')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('no')"
      />
      <path
        id="no_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('nz') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('nz')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('nz')"
      />
      <path
        id="nz_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('pg') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('pg')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('pg')"
      />
      <path
        id="pg_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ph') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ph')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ph')"
      />
      <path
        id="ph_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('pt') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('pt')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('pt')"
      />
      <path
        id="pt_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ru') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ru')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ru')"
      />
      <path
        id="ru_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sb') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sb')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sb')"
      />
      <path
        id="sb_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('sc') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('sc')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('sc')"
      />
      <path
        id="sc_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('se') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('se')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('se')"
      />
      <path
        id="se_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('st') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('st')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('st')"
      />
      <path
        id="st_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('us') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('us')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('us')"
      />
      <path
        id="us_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('vc') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('vc')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('vc')"
      />
      <path
        id="vc_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('vu') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('vu')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('vu')"
      />
      <path
        id="vu_1"
      ...
      <path
        ...
        :class="[
          'transition-all duration-300 stroke-[#38bdf8]/20 hover:fill-accent-blue/30 cursor-pointer',
          selectedRegion === getRegionOfCountry('ye') ? 'fill-accent-blue/25 stroke-accent-blue/60' : getRegionClass('ye')
        ]"
        stroke-width="0.5"
        @click="handleCountryClick('ye')"
      />
      <path
        id="ye_1"
      ...
      />
        ...
        <g id="data-beams">
          <path d="M220,390 L440,350" stroke="#38bdf8" stroke-width="1.25" class="animate-data-beam" opacity="0.25" />
          <path d="M440,350 L640,410" stroke="#38bdf8" stroke-width="1.25" class="animate-data-beam" opacity="0.25" />
          <path d="M320,580 L490,510" stroke="#38bdf8" stroke-width="1.25" class="animate-data-beam" opacity="0.25" />
          <path d="M490,510 L640,410" stroke="#38bdf8" stroke-width="1.25" class="animate-data-beam" opacity="0.25" />
          <path d="M220,390 L320,580" stroke="#38bdf8" stroke-width="1.25" class="animate-data-beam" opacity="0.25" />
          <path d="M640,410 L710,640" stroke="#38bdf8" stroke-width="1.25" class="animate-data-beam" opacity="0.25" />
        </g>
        ...
        <g v-for="hub in REGION_HUBS" :key="hub.id" class="cursor-pointer group" @click="handleRegionClick(hub)">
          <!-- Radar ping circle (glowing and pulsing for active threats) -->
          <circle
            v-if="hubMetrics[hub.id].total > 0"
            :cx="hub.x"
            :cy="hub.y"
            :r="selectedRegion === hub.id ? 22 : 12"
            class="animate-radar-ping"
            :style="{
              stroke: hubMetrics[hub.id].critical > 0 ? '#f7768e' : hubMetrics[hub.id].high > 0 ? '#e0af68' : '#38bdf8',
            }"
            stroke-width="1"
            fill="none"
          />
          ...
          <circle
            ...
            fill="none"
          />
          <!-- Pulse ring for selected / active hub -->
          <circle
...
.animate-radar-ping {
  ...
  animation: radarPing 2.2s infinite cubic-bezier(0.1, 0.8, 0.3, 1);
}
